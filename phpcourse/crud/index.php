...
<body>
    ...
    <div class="navbar">
        <ul>
            ...
            <li ><a href="assets/dashboard.php"><i class="fa-solid fa-gauge"></i>Dashboard</a></li>
            <li><a href="assets/calander.php"><i class="fa-solid fa-calendar"></i>Calendar</a></li>
            <li><a href="assets/about.php"><i class="fa-solid fa-address-card"></i>About</a></li>
